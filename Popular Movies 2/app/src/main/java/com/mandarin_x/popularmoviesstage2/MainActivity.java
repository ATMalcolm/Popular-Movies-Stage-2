...
import com.mandarin_x.popularmoviesstage2.PosterAdapter.PosterAdapterOnClickHandler;
import com.mandarin_x.popularmoviesstage2.data.FavoritesContract;
import com.mandarin_x.popularmoviesstage2.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements PosterAdapterOnClickHandler {
    ...
    private com.mandarin_x.popularmoviesstage2.PosterAdapter mPosterAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPosterAdapter = new com.mandarin_x.popularmoviesstage2.PosterAdapter(this);
    ...
    public void onClick(Movie movie) {
        ...
        Intent intent = new Intent(this, com.mandarin_x.popularmoviesstage2.DetailActivity.class);
        intent.putExtra("movie", movie);
        intent.putExtra("posters_base_url", com.mandarin_x.popularmoviesstage2.PosterAdapter.POSTERS_BASE_URL);
        intent.putExtra("poster_width", com.mandarin_x.popularmoviesstage2.PosterAdapter.POSTER_WIDTH);
